  ...
  try {
    if (mode == "APPOINTMENT") {
      return await transport.sendMail({
        ...
        <hr>
        <p><b>Doctor Name</b> : ${docData.name} </p>
        <p><b>Doctor Department</b> : ${docData.department} </p>
        <hr>
        <p><b>Patient Name</b> : ${appoData.paitent.pname} </p>
        <p><b>Patient Email</b> : ${appoData.paitent.email} </p>
        <p><b>Patient Contact</b> : ${appoData.paitent.contact} </p>
